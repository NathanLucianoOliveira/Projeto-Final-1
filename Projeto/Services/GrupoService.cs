...
{
    public class GrupoService(DatabaseContext context)
    {
        ...
        public async Task<Response<Grupo>> Create(Grupo grupo, Guid userId)
        {
            grupo.DonoId = userId;
        ...
        public async Task<Response> Update(Grupo grupo, Guid userId)
        {
        ...
        public async Task<Response<string>> CriarConvite(Guid grupoId, Guid usuarioId)
        {
            ...
            {
                GrupoId = grupoId,
                Codigo = Random.Shared.Next(1000, 9999)
            };
        ...
        public async Task<Response> AceitarConvite(int codigo, Guid usuarioId)
        {
        ...
        public async Task<Response> Sortear(Guid grupoId, Guid usuarioId)
        {
            var grupo = await GetById(grupoId, usuarioId);
            if (grupo == null)
                return new("Grupo não encontrado.");
